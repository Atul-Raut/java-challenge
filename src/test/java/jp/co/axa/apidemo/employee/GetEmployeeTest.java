...
public class GetEmployeeTest {
	...
	public void TC1_testNoEmployee() throws Exception {
        ...
        HttpGet request = new HttpGet(apiUrl + "/1");
	...
	/**
     * Test Case ID: TC002
     * Test Case Title: Verify that the employee returned.
     * Test Objective: To ensure that target employee returned.
     * Preconditions: The application is running. Assumed no employee registered.
     */
	@Test
	public void TC2_testEmployee() throws Exception {
		int noOfEmp = 1;
        ...
        // check errors
        Assertions.assertTrue((noOfEmp == count), "Target employee not returned.");
	}
