...
public class UpdateEmployeeTest {
     ...
     */
	@Test
	public void TC1_testNoEmployeeForUpdate() throws Exception {

        // Create an HTTP PUT request to the API endpoint
        HttpPut request = new HttpPut(apiUrl + "/1");
	...
	/**
     * Test Case ID: TC002
     * Test Case Title: Verify that the employee update.
     * Test Objective: To ensure that target employee updates.
     * Preconditions: The application is running. Assumed no employee registered.
     */
	@Test
	public void TC2_testEmployeeUpdate() throws Exception {
		int noOfEmp = 1;
        ...
        String jsonPayload = "{\"name\":\"Test1_UPD_TC002\",\"salary\":5000, \"department\":\"department1_UPD_TC002\"}";
